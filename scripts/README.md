...
### macOS / Linux
```bash
curl -fsSL https://raw.githubusercontent.com/abhigyanwebber/cmd-customizer/main/scripts/install.sh | bash
```

### Manual (all platforms)
```bash
git clone https://github.com/abhigyanwebber/cmd-customizer
cd cmd-customizer
go build -o cmdx ./cmd/
```
